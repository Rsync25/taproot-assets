...
type MintingBatchRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MintingBatchRequest) Reset() {
	*x = MintingBatchRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MintingBatchRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MintingBatchRequest) ProtoMessage() {}

func (x *MintingBatchRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mintrpc_mint_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MintingBatchRequest.ProtoReflect.Descriptor instead.
func (*MintingBatchRequest) Descriptor() ([]byte, []int) {
	return file_mintrpc_mint_proto_rawDescGZIP(), []int{3}
}

func (x *MintingBatchRequest) GetBatchKey() []byte {
	if x != nil {
		return x.BatchKey
	}
	return nil
...
type MintingBatchResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Assets      []*MintAsset `protobuf:"bytes,1,rep,name=assets,proto3" json:"assets,omitempty"`
	TaroRootKey []byte       `protobuf:"bytes,2,opt,name=taro_root_key,json=taroRootKey,proto3" json:"taro_root_key,omitempty"`
}

func (x *MintingBatchResponse) Reset() {
	*x = MintingBatchResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MintingBatchResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MintingBatchResponse) ProtoMessage() {}

func (x *MintingBatchResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mintrpc_mint_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MintingBatchResponse.ProtoReflect.Descriptor instead.
func (*MintingBatchResponse) Descriptor() ([]byte, []int) {
	return file_mintrpc_mint_proto_rawDescGZIP(), []int{4}
}

func (x *MintingBatchResponse) GetAssets() []*MintAsset {
	if x != nil {
		return x.Assets
	}
	return nil
...
func (x *MintingBatchResponse) GetTaroRootKey() []byte {
	if x != nil {
		return x.TaroRootKey
	}
	return nil
}
...
var file_mintrpc_mint_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xea, 0x01, 0x0a, 0x04, 0x4d, 0x69, 0x6e,
	...
	,
	...
	0x73, 0x2f, 0x74, 0x61, 0x72, 0x6f, 0x72, 0x70, 0x63, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x72, 0x70,
...
var file_mintrpc_mint_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_mintrpc_mint_proto_goTypes = []interface{}{
	...
	(*MintingBatchRequest)(nil),    // 3: mintrpc.MintingBatchRequest
	(*MintingBatchResponse)(nil),   // 4: mintrpc.MintingBatchResponse
	(*PauseAutoBatchRequest)(nil),  // 5: mintrpc.PauseAutoBatchRequest
	(*PauseAutoBatchResponse)(nil), // 6: mintrpc.PauseAutoBatchResponse
	(tarorpc.AssetType)(0),         // 7: tarorpc.AssetType
}
var file_mintrpc_mint_proto_depIdxs = []int32{
	7, // 0: mintrpc.MintAsset.asset_type:type_name -> tarorpc.AssetType
	0, // 1: mintrpc.MintAssetRequest.asset:type_name -> mintrpc.MintAsset
	0, // 2: mintrpc.MintingBatchResponse.assets:type_name -> mintrpc.MintAsset
	1, // 3: mintrpc.Mint.MintAsset:input_type -> mintrpc.MintAssetRequest
	3, // 4: mintrpc.Mint.MintingBatch:input_type -> mintrpc.MintingBatchRequest
	5, // 5: mintrpc.Mint.PauseAutoBatch:input_type -> mintrpc.PauseAutoBatchRequest
	2, // 6: mintrpc.Mint.MintAsset:output_type -> mintrpc.MintAssetResponse
	4, // 7: mintrpc.Mint.MintingBatch:output_type -> mintrpc.MintingBatchResponse
	6, // 8: mintrpc.Mint.PauseAutoBatch:output_type -> mintrpc.PauseAutoBatchResponse
...
func file_mintrpc_mint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mintrpc_mint_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MintingBatchRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mintrpc_mint_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MintingBatchResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
